...
class ModelGenerator:
    ...
    Args:
        ...
        default_module_name (str, optional): The default module name used when solving imports for types defined in the main script. Defaults to "data_schema_models.generators".
    ...
    def __init__(
        ...
        default_module_name: str = "data_schema_models.generators",
        **kwargs,
    ) -> None:
